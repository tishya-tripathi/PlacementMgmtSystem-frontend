...
export default function Footer() {
  return (
    ...
    >
      ...
      >
        <Link color="inherit" href="https://www.rnsit.ac.in/"><EmailIcon fontSize="large"/></Link>
        <Link color="inherit" href="https://www.rnsit.ac.in/"><TwitterIcon fontSize="large"/></Link>
        <Link color="inherit" href="https://www.rnsit.ac.in/"><LinkedInIcon fontSize="large"/></Link>
        <Link color="inherit" href="https://www.rnsit.ac.in/"><FacebookIcon fontSize="large"/></Link>
      </Box>
      </div>
